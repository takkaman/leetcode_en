...
public class Solution1306 {
    ...
    public boolean canReach(int[] arr, int start) {
        ...
        return canReachAtomic(arr, start);
    }

    public boolean canReachAtomic(int[] arr, int start) {
        ...
        if (start - step >= 0 && start + step <= arr.length - 1) {
            return canReachAtomic(arr, start - step) || canReachAtomic(arr, start + step);
        } else if (start - step >= 0) {
            return canReachAtomic(arr, start - step);
        } else if (start + step <= arr.length - 1) {
            return canReachAtomic(arr, start + step);
        } else {
            return false;
        }
